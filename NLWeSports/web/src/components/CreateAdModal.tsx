...
type SelectGame = Pick<Game, "id" | "title">;

export function CreateAdModal() {
  const [games, setGames] = useState<SelectGame[]>([]);
  const [weekDays, setWeekDay] = useState<string[]>([]);
        ...
        <form onSubmit={handleCreateAd} className="mt-8 flex flex-col gap-4">
          <div className="flex flex-col gap-2">
            ...
            <select
              name="game"
              id="game"
              className="bg-zinc-900 py-3 px-4 rounded text-sm placeholder:text-bg-zinc-500 appearance-none"
              defaultValue=""
            >
          ...
          <div className="grid grid-cols gap-6">
            ...
            <div className="flex flex-col gap-2">
              <label htmlFor="discord">Qual o seu Dircord?</label>
              <Input
                name="discord"
                id="discord"
                type="text"
          ...
          <label className="mt-2 flex gap-2">
            <Checkbox.Root
              ...
              className="w-6 h6 items-center p-1 rounded bg-zinc-900"
            >
              <Checkbox.Indicator>
